...
- **APIキー管理**: アプリ内からClaude APIキーの設定・削除が可能
- **プロンプト生成モード**: APIキー未登録でもチャートデータとプロンプトをコピーして他のAIに渡せる
- **地方グループ付き都市選択**: 日本全国65都市＋海外主要都市を地方別にグループ化
- **緯度経度の直接入力**: 都市リストにない場所でもチャート生成が可能
...
Claude APIキーはアプリ内の設定ボタンから登録できます。APIキーがなくてもチャート生成とプロンプト生成は利用可能です。
